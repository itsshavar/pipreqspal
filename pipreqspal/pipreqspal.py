...
def init(args):
    ...
    walk = os.walk(input_path, followlinks=follow_links)
    func = partial(get_all_imports,encoding=encoding,extra_ignore_dirs=extra_ignore_dirs)
    candidates = pool.map(func,walk)
